...
2. Run "go run src/server/main.go" in the first terminal. This is to launch the backend portion of our project. If you get an error message such as 'cannot find package "github.com/..." in any of: ...', then run 'go get "github.com/..."' for that package.
